...
namespace Abrasf.Core.ConsultarNfseServicoTomado.Validator
{

    public class ConsultarNfseServicoTomadoValidator : IConsultarNfseServicoTomadoValidator
    {
        private const string Operation = "ConsultarNfseServicoTomado";
        ...
        private bool ValidateSchema(string xml)
        {
            try
            {
                ...
                var consultarNfseServicoTomado = "Schemas//consultarNfseServicoTomado.xsd";
                ...
                cfg.Schemas.Add(null, consultarNfseServicoTomado);
