...
namespace Abrasf.Core.ConsultarNfseFaixa.Validator
{

    public class ConsultarNfseFaixaValidator : IConsultarNfseFaixaValidator
    {
        private const string Operation = "ConsultarNfseFaixa";
        ...
        private bool ValidateSchema(string xml)
        {
            try
            {
                ...
                var consultarNfseFaixa = "Schemas/204/consultarNfseFaixa.xsd";
                ...
                cfg.Schemas.Add(null, consultarNfseFaixa);
