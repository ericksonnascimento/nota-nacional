...
namespace Abrasf.Core.CancelarNfse.Validator
{

    public class CancelarNfseValidator : ICancelarNfseValidator
    {
        private const string Operation = "CancelarNfse";
        ...
        private bool ValidateSchema(string xml)
        {
            try
            {
                ...
                var cancelarNfse = "Schemas//cancelarNfse.xsd";
                ...
                cfg.Schemas.Add(null, cancelarNfse);
