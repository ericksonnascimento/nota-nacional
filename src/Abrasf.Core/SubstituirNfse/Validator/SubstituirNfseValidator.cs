...
namespace Abrasf.Core.SubstituirNfse.Validator
{

    public class SubstituirNfseValidator : ISubstituirNfseValidator
    {
        private const string Operation = "SubstituirNfse";
        ...
        private bool ValidateSchema(string xml)
        {
            try
            {
                ...
                var substituirNfse = "Schemas/204/substituirNfse.xsd";
                ...
                cfg.Schemas.Add(null, substituirNfse);
