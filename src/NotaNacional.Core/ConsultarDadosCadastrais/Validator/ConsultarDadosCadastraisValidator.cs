...
{
    public class ConsultarDadosCadastraisValidator : IConsultarDadosCadastraisValidator
    {
        private const string Operation = "ConsultarDadosCadastrais";
        ...
        private bool ValidateSchema(string xml)
        {
            try
            {
                ...
                var ConsultarDadosCadastrais = "Schemas/nacional/v100/consultarDadosCadastrais.xsd";
                ...
                cfg.Schemas.Add(null, ConsultarDadosCadastrais);
