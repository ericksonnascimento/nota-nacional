...
namespace NotaNacional.Core.RecepcionarLoteRps.Handlers
{
    ...
    public class RecepcionarLoteRpsHandler : BaseHandler, IRecepcionarLoteRpsHandler
    {
        ...
        private NotaNacional.Core.Models.EnviarLoteDpsResposta BuildResponse(WsNfseEnviarLoteRpsResult result)
        {
